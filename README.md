...
Six models with the same variables and trained on the same “training set” are used; their performance is analyzed on the test set. To this end, are used two distinct approaches: the former of statistical nature, compares the models with classification measurements (including accuracy and Mse) while the latter is of a more economic nature. This last evaluation passes through the maximisation of profits, in the light of the costs of contacting consumers and the budget constraint set up for the direct marketing campaign.
